...
label = Label(root2, font = ('arial',50,'bold'), text =" RULES FOR BILLING ", bg = "dark blue" ,fg="sky blue",bd = 10,pady=15,relief=RIDGE)
label.grid(row = 0,column=2)
label1 = Label(root2, font = ('arial',20,'bold'), text ="1.Need to fill customer\ndetail", fg = "dark blue" ,bg="sky blue")
label1.grid(row = 3,column=0) 
label2 = Label(root2, font = ('arial',20,'bold'), text ="2.select type and show", fg = "dark blue" ,bg="sky blue")
label2.grid(row = 4,column=0)  
label3 = Label(root2, font = ('arial',20,'bold'), text ="3.select item and press \nadd item ", fg = "dark blue" ,bg="sky blue")
label3.grid(row = 5,column=0) 
label4 = Label(root2, font = ('arial',20,'bold'), text ="4.press bill button\nfor generating bill", fg = "dark blue" ,bg="sky blue")
...
menu_category = ["Tea & Coffee","Beverages","Fast Food","Starters","Main Course","Dessert"," South Indian"]
...
menu_category_dict = {"Tea & Coffee":"1 Tea & Coffee.txt","Beverages":"2 Beverages.txt",
                ...
                "Dessert":"6 Dessert.txt"," South Indian":"7 South Indian.txt"}

order_dict = {}
for i in menu_category:
    order_dict[i] = {}

os.chdir(os.path.dirname(os.path.abspath('C:\\Users\\SAPNA\\anaconda3\\bin\\Menu')))
...
menu_frame.place(x=0,y=125,height=560,width=800)
...
item_frame.place(x=680,y=125,height=250,width=850)
...
order_frame.place(x=680,y=335,height=450,width=860)
...
order_tabel_frame.place(x=0,y=40,height=480,width=820)
